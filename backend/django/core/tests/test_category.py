...
from core.models import Category, CategoryType, Organization, Transaction, User
...
def test_list_categories_returns_categories_and_supports_type_filter(
    ...
    response = api_client.get(categories_url(shared_org.id), {"type": CategoryType.EXPENSE})

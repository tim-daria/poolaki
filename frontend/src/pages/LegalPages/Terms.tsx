/** @file Terms of Service page featuring collapsible section cards and native PageActionButton. */
...
import { PageActionButton } from "../../components/PageHeader/PageHeader";
  ...
  return (
    <Container
      ...
      sx={{
        ...
        gap: 3,
        // Global anchor link color styling within the legal container
        "& a": {
          color: "primary.main",
    ...
    >
      {/* Top header row: Page title on left, native PageActionButton on right */}
      <Box
        sx={{
          display: "flex",
      ...
      >
        ...
        {/* Reusing the app's standard action button component */}
        <PageActionButton
      ...
      >
        ...
        {expanded.sec16 && (
          <Box display="flex" flexDirection="column" gap={1.5} sx={{ mt: 1 }}>
            <Typography variant="body2" sx={{ color: "text.secondary", lineHeight: 1.5 }}>
              <strong>16.1 Entire agreement.</strong> These Terms, together with the Privacy Policy, constitute the entire agreement between you and Poolaki regarding the Service.
            </Typography>
            <Typography variant="body2" sx={{ color: "text.secondary", lineHeight: 1.5 }}>

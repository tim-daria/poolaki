...
//   const color =
//     clamped >= 80 ? "#27ae60" : clamped >= 40 ? "#6c63ff" : "#f39c12";
//   return (
...
//             {goal.category} · By {formatDate(goal.deadline)}
//           </p>
//         </div>
//         <div className={styles.cardRight}>
//           <span className={styles.cardSaved}>
...
//       </div>
//       <ProgressBar pct={pct} />
//       <p className={styles.cardPct}>
//         {pct.toFixed(0)}% saved of €{goal.targetAmount.toLocaleString()}
//       </p>
//     </div>
//   );
// }
...
//   const [modalMode, setModalMode] = useState<"goal" | "transaction" | null>(
//     null,
//   );
...
//           <p className={styles.overviewSub}>
//             {totalPct.toFixed(0)}% of all goals funded
//           </p>
//         </div>
//         <div className={styles.overviewCard}>
...
//               <p className={styles.overviewSub}>
//                 €{closest.savedAmount.toLocaleString()} saved of €
//                 {closest.targetAmount.toLocaleString()}
//               </p>
//               <ProgressBar
//                 pct={(closest.savedAmount / closest.targetAmount) * 100}
//               />
//               <p className={styles.overviewSub}>
//                 {((closest.savedAmount / closest.targetAmount) * 100).toFixed(
//                   0,
//                 )}
//                 %
//               </p>
